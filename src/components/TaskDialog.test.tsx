...
describe('TaskDialog', () => {
  ...
  it('should render dialog when open', () => {
    render(
      <TaskDialog task={mockTask} open={true} onOpenChange={mockOnOpenChange} />
    )
  ...
  it('should not render dialog when closed', () => {
    render(
      <TaskDialog task={mockTask} open={false} onOpenChange={mockOnOpenChange} />
    )
  ...
  it('should prefill form with task data', () => {
    ...
    render(
      <TaskDialog task={taskWithDescription} open={true} onOpenChange={mockOnOpenChange} />
    )
  ...
  it('should have maxLength on description textarea', () => {
    ...
    const descriptionTextarea = screen.getByPlaceholderText('Add a more detailed description...') as HTMLTextAreaElement
